...
<body>
	...
	<form class="layui-form" action="addBackMoney" method="POST">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="customer" lay-verify="required"
					...
					value="${requestScope.data.customer}">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="percent" placeholder="请输入总盈亏"
					autocomplete="off" class="layui-input" readonly="readonly"
					value="${requestScope.data.percent}">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="custompercent" placeholder="请输入客户盈亏"
					autocomplete="off" class="layui-input" readonly="readonly"
					value="${requestScope.data.custompercent}">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="devidepoint" placeholder="请输入分成比例"
					autocomplete="off" class="layui-input" readonly="readonly"
					value="${requestScope.data.devidepoint}">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="devidenum" lay-verify="required|number"
					...
					readonly="readonly" value="${requestScope.data.devidenum}">
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="comment" placeholder="请输入备注信息"
					class="layui-textarea" readonly="readonly">${requestScope.data.sendoutprice}</textarea>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
