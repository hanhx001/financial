...
<body>
	<blockquote class="layui-elem-quote layui-text">温馨提示：这里是你点击股票代码后 跳转的详情界面</blockquote>
	...
	<c:choose>
		...
		<%--止盈 --%>
		<c:when test="${requestScope.pagetype==2}">  
         作品2名称: <br />
         作品2编号:  <br />
		</c:when>
		<%--止损 --%>
		<c:when test="${requestScope.pagetype==3}">  
         作品3名称: <br />
         作品3编号:  <br />
		</c:when>
