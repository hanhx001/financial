...
},beforePageText:"页",afterPageText:"到 {pages}",displayMsg:"显示 {from} 到 {to} 共 {total} 记录",nav:{first:{iconCls:"pagination-first",handler:function(){
